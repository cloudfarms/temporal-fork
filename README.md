...
This repo contains fork of temporal with jwt claim mapper.

More information on how to build and release new versions here: https://github.com/cloudfarms/temporal-docker-builds-fork
